...
open class JXSegmentedTitleCell: JXSegmentedBaseCell {
    ...
    open var backViewColor: UIColor? {
        didSet{
            self.backView.backgroundColor = backViewColor
        }
    }
    public var backViewHeight: CGFloat = 26.0
    public var backViewExtraWidth: CGFloat = 14.0
    ...
    open override func layoutSubviews() {
        ...
        //额外增加
        let backViewBounds = CGRect(x: 0, y: 0, width: labelSize.width + backViewExtraWidth, height: backViewHeight)
        backView.center = contentView.center
        backView.bounds = backViewBounds
        //额外增加
    }
