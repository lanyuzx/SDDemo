...
class SDAlertAnimation: NSObject {
    
    var interactor: SDInteractiveTransition
    private var presenting: Bool = false
    
    public class func animationIsPresenting(isPresenting: Bool, interactor: SDInteractiveTransition) -> SDAlertAnimation{
        let alertAnimation = SDAlertAnimation.init(isPresenting: isPresenting, interactor: interactor)
        return alertAnimation
    }
    
    private init(isPresenting: Bool, interactor: SDInteractiveTransition) {
...
extension SDAlertAnimation: UIViewControllerAnimatedTransitioning{
...
extension SDAlertAnimation {
    ...
    private func presentAnimationTransition(transitionContext: UIViewControllerContextTransitioning){
        ...
        guard let alert = alertController as? SDCustomAlertController else { return }
    ...
    // 从底部弹出的present动画
    private func raiseUpWhenPresent(forController alertController: SDCustomAlertController,
    ...
    // 从底部弹出对应的dismiss动画
    private func dismissCorrespondingRaiseUp(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 从右边弹出的present动画
    private func fromRightWhenPresent(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 从右边弹出对应的dismiss动画
    private func dismissCorrespondingFromRight(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 从左边弹出的present动画
    private func fromLeftWhenPresent(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 从左边弹出对应的dismiss动画
    private func dismissCorrespondingFromLeft(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 从顶部弹出的present动画
    private func dropDownWhenPresent(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 从顶部弹出对应的dismiss动画
    private func dismissCorrespondingDropDown(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
        let duration = self.transitionDuration(using: transition)
        UIView.animate(withDuration: duration, animations: {
            var controlViewFrame = alertController.view.frame
    ...
    private func alphaWhenPresent(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    private func dismissCorrespondingAlpha(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 发散的prensent动画
    private func expandWhenPresent(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 发散对应的dismiss动画
    private func dismissCorrespondingExpand(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 收缩的present动画
    private func shrinkWhenPresent(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 收缩对应的的dismiss动画
    private func dismissCorrespondingShrink(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 无动画
    private func noneWhenPresent(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    // 无动画
    private func dismissCorrespondingNone(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
        transition.completeTransition(transition.isAnimated)
    }
    
    // 手势退出
    private func dismissInteractive(forController alertController: SDCustomAlertController,
                                         transition: UIViewControllerContextTransitioning) {
    ...
    private func offSetCenter(alertController: SDCustomAlertController) {
