//
//  SDAlertPresentationController.swift
//  SDAlterSheet
//
...
class SDAlertPresentationController: UIPresentationController {
    ...
    override func presentationTransitionWillBegin() {
        ...
        let alertController = self.presentedViewController as! SDCustomAlertController
        if customOverlayView == nil {
            (overlayView as! SDOverlayView).setAppearanceStyle(appearanceStyle: alertController.backgroundViewAppearanceStyle, alpha: alertController.backgroundViewAlpha)
        }
    ...
    private var overlayView: UIView {
        if _overlayView == nil {
            if let customView = customOverlayView {
                ...
                _overlayView = SDOverlayView.init()
            }
